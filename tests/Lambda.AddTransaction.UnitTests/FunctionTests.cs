...
namespace Lambda.AddTransaction.UnitTests
{
    public class FunctionTests
    {
        ...
        {
            // Arrange
            var request = new APIGatewayProxyRequest() { Body = JsonSerializer.Serialize(new TransactionDto()) };
        ...
        [Fact]
        public async void If_Successfuly_Function_Returns_201()
        {
            // Arrange
